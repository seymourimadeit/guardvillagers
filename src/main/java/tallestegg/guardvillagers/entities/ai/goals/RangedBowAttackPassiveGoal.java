...
public class RangedBowAttackPassiveGoal<T extends Guard & RangedAttackMob> extends Goal {
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.entity.isUsingItem() && !this.entity.isBlocking()) {
                ...
                this.entity.startUsingItem(GuardItems.getHandWith(entity, item -> item instanceof BowItem));
            }
